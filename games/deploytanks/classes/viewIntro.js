...
{ 
	...
	{ 
			...
			if (m_keyboardMngr.isKeyDown(C_BUTTON_B_KEY) == true || m_keyboardMngr.isKeyDown(C_KEY_RETURN) == true)
			{
				...
				m_keyboardMngr.disableUntilKeyUp(C_BUTTON_B_KEY);
	...
	{
		drawImage_wh(m_canvas, m_context, m_resourceMngr.getImage(C_IMG_MAIN_MENU), this.m_midX - 64,10);
		...
		m_fontMngr.drawText(m_canvas, m_context, 'USE ARROWS AND ENTER OR', this.m_midX - (20 * 9), 300 + 24*4, rgbToColor(16,16,16));
		m_fontMngr.drawText(m_canvas, m_context, ' TOUCH CENTER 3 TIMES', this.m_midX - (20 * 9), 300 + 24*5, rgbToColor(16,16,16));
