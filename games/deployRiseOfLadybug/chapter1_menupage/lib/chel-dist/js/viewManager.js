...
ViewManager.prototype.setObjectCanvasAndContext = function (_object)
{
	_object.canvas = this.m_canvasEx.m_canvas;
	_object.context = this.m_canvasEx.m_context;
};
...
ViewManager.prototype.initializeFontManager = function (_fontImage, _fontSmallImage, _fontWidth, _fontHeight, _fontMap)
{
	var result = true;  
	...
	try
	{
		this.m_fontManager.setFontImages(
...
ViewManager.prototype.navigateTo = function (_id)
{
	...
	if (this.isCurrentPageValid() === true)
	{
		console.log("ENTER TO: " + this.getCurrentPage().getPageName());
...
ViewManager.prototype.animationCycle = function ()
{
	...
	if (C_LOG === true)
	{
		...
		writeMessage(this.m_canvasEx.m_context, this.m_messageByTick, 4, 16, 9, "Calibri", "red", C_DEBUG_MODE);
		writeMessage(this.m_canvasEx.m_context, this.m_messageByCycle, 200, 16, 9, "Calibri", "red", C_DEBUG_MODE);
	}
...
ViewManager.prototype.render = function ()
{
	...
	if (this.m_refresh === true)
	{
        ...
        renderRectangle(this.m_canvasEx.m_canvas, this.m_canvasEx.m_context, 0,0, this.m_canvasEx.m_canvas.width, this.m_canvasEx.m_canvas.height, null, "#000000", 1, 1);
