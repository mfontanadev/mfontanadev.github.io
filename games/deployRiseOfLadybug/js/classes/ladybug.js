...
function Ladybug()
{
    ...
    Ladybug.prototype.implementGameLogic = function () 
    {
        ...
        if (this.m_perturbation === true)
        {
            px = px + chRandom(3) * (0 - chRandom(1));
            py = py + chRandom(3) * (0 - chRandom(1));
        }
    ...
    {   
        ...
        {
            rendercollisionRectangle(this.m_viewManager.m_canvasEx.m_canvas, 
            this.m_viewManager.m_canvasEx.m_context, this.collisionRectangle(), 'magenta')
        }
    };
    ...
    Ladybug.prototype.applyBranchCollision = function(_energyChange)
    {
        this.applyEnergy(_energyChange);       
        
        if (_energyChange < 0)
            this.m_perturbation = true;
    }
