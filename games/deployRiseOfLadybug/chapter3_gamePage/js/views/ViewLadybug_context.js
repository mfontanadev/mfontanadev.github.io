...
ViewLadybug_context.C_PAGE_FLYING = 1;
ViewLadybug_context.C_PAGE_INTER_MISSION = 2;
ViewLadybug_context.C_PAGE_CREDITS = 3;
...
{ 
	...
	ViewLadybug_context.prototype.createpages = function ()
	{
		...
		result.push(new ViewLadybug_gamePage(ViewLadybug_context.C_PAGE_FLYING, this.m_viewManager));
		result.push(new ViewLadybug_interMissionPage(ViewLadybug_context.C_PAGE_INTER_MISSION, this.m_viewManager));
		result.push(new ViewLadybug_creditsPage(ViewLadybug_context.C_PAGE_CREDITS, this.m_viewManager));
	...
	ViewLadybug_context.prototype.mustDrawGuinnessIndicator = function ()
	{
		return (this.m_viewManager.getDataContext().m_bestTime > 0);
    }
